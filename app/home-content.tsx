...
import type { RecentScore, TopPlayer } from "./lib/scores";
...
const FEATURES = [
  {
    i: "GAMEPAD",
    t: "JUEGOS CLÁSICOS",
    d: "Los mejores arcades de todos los tiempos en un solo lugar.",
    c: "cyan",
  },
  {
    i: "FREE",
                ...
                {recentScores.map((r, i) => {
                  ...
                  return (
                    <div key={i} className="tick-row" style={{ animationDelay: i * 60 + "ms" }}>
                      <span className={"tk-p neon-" + color}>{r.playerName}</span>
                      <span className="tk-mid">▸ {game?.title ?? r.gameId}</span>
            ...
            {topPlayers.length === 0 ? (
              ...
              <div className="top-list">
                {topPlayers.map((r, i) => (
                  ...
                  >
                    <span className="tp-rk">#{String(i + 1).padStart(2, "0")}</span>
                        ...
                        style={{
                          width:
                            topPlayers[0].score > 0
                              ? (r.score / topPlayers[0].score) * 100 + "%"
                              : "0%",
                        }}
                      ></span>
                    </span>
